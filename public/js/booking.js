...
const translations = {
  uk: {
    ...
    bookingHeaderSeal: 'Безшовне бронювання для гостей',
    bookingQuickHome: 'Головна',
    bookingQuickMenu: 'Меню',
    bookingQuickEvents: 'Події',
    bookingQuickContacts: 'Контакти',
    ...
    backHome: '← На головну',
    heroNote: 'Живий статус столів, вибір зони та бронювання в одному потоці.',
    statFreeHint: 'Готові до бронювання зараз',
    statBusyHint: 'Уже запитані гостями',
    statHeldHint: 'Тимчасово зарезервовані',
    statFree: 'Вільно',
    statBusy: 'Зайнято',
  ...
  en: {
    ...
    bookingHeaderSeal: 'Seamless guest reservations',
    bookingQuickHome: 'Home',
    bookingQuickMenu: 'Menu',
    bookingQuickEvents: 'Events',
    bookingQuickContacts: 'Contacts',
    bookingEyebrow: 'GorPliaj Booking',
    ...
    backHome: '← Back home',
    heroNote: 'Live table status, area selection, and booking in one streamlined flow.',
    statFreeHint: 'Ready to reserve now',
    statBusyHint: 'Already requested',
    statHeldHint: 'Temporarily reserved',
    statFree: 'Free',
    statBusy: 'Busy',
    statHeld: 'Held',
