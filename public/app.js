...
const translations = {
  uk: {
    ...
    headerSeal: 'Гостинність узбережжя Отради',
    ...
    heroFloatingPill: 'Преміальний відпочинок біля моря',
    ...
    heroPromoChip: 'Сервіс біля моря',
    heroPromoLink: 'Дізнатися контакти',
    highlightMenuHint: 'Добірка фаворитів гостей',
    highlightBookingHint: 'Швидке підтвердження заявки',
    highlightZonesHint: 'Від пляжу до тераси',
    signatureCuisine: 'Фірмова кухня',
    signatureCuisineValue: 'Середземноморський комфорт',
    signatureSunset: 'Атмосфера заходу сонця',
    signatureSunsetValue: 'Тераса та пляжна лінія',
    signatureBooking: 'Гостьовий сервіс',
    signatureBookingValue: 'Бронювання за лічені хвилини',
  ...
  en: {
    ...
    brandSubtitle: 'Beach · Restaurant · Events',
    headerSeal: 'Otrada coast hospitality',
    ...
    heroFloatingPill: 'Premium seaside destination',
    ...
    heroPromoChip: 'Seaside service',
    heroPromoLink: 'View contacts',
    highlightMenuHint: 'Curated guest favorites',
    highlightBookingHint: 'Fast confirmation flow',
    highlightZonesHint: 'Beachfront to terrace',
    signatureCuisine: 'Signature cuisine',
    signatureCuisineValue: 'Mediterranean comfort',
    signatureSunset: 'Sunset mood',
    signatureSunsetValue: 'Terrace & beach line',
    signatureBooking: 'Guest flow',
    signatureBookingValue: 'Booking in minutes',
