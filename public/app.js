...
const translations = {
  uk: {
    ...
    heroDescription: 'Меню, онлайн-бронювання, мапа закладу та анонси подій зібрані в одному сучасному інтерфейсі для гостей.',
    heroPrimaryCta: 'Забронювати онлайн',
    heroMenuCta: 'Переглянути меню',
    heroSecondaryCta: 'Відкрити мапу закладу',
    ...
    menuPreviewSecondary: 'Забронювати столик',
    ...
    bookingMapCta: 'Відкрити мапу закладу',
  ...
  en: {
    ...
    menuPreviewSecondary: 'Book a table',
    bookingKicker: 'Fast reservation',
...
function initScrollReveal() {
  ...
  const shouldUseLightScrollMode = prefersReducedMotion || prefersLowData || isTouchDevice;

  if (shouldUseLightScrollMode) {
    document.body.classList.add('performance-scroll-lite');
