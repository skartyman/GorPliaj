...
const translations = {
  uk: {
    ...
    visualText: 'Оновлена головна сторінка робить акцент на логічній подачі інформації: атмосфера, меню та бронювання, а потім контакти й умови користування.',
  ...
  en: {
    ...
    visualText: 'The refreshed homepage follows a clearer order: atmosphere, menu and booking, followed by contacts and usage terms.',
    menuKicker: 'Kitchen & bar',
