...
const translations = {
  uk: {
    ...
    bookingAsidePhotoText: 'Для великих компаній рекомендуємо обирати терасу або лаунж та уточнювати побажання у формі.',
  ...
  en: {
    ...
    bookingAsidePhotoText: 'For larger groups, we recommend choosing the terrace or lounge and adding your requests in the form.',
    eventsKicker: 'Live atmosphere',
