  ...
  ua: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'Бронювання здійснюється за умови 100% передоплати. Бронювання дійсне до 13:00 оплаченого дня. У разі неявки гостя до 13:00 адміністрація має право скасувати бронювання, а 50% суми передоплати утримується як компенсація за резервування місця.'
      },
      {
  ...
  ru: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'Бронирование осуществляется при условии 100% предоплаты. Бронирование действительно до 13:00 оплаченного дня. При неявке гостя до 13:00 администрация вправе отменить бронирование, а 50% суммы предоплаты удерживается как компенсация за резервирование места.'
      },
      {
  ...
  en: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'Bookings require 100% prepayment. A booking remains valid until 1:00 PM on the paid day. If the guest does not arrive by 1:00 PM, the venue may cancel the booking and retain 50% of the prepayment as compensation for holding the place.'
      },
      {
        title: '5. Refunds',
